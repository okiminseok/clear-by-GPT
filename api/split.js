...
Universality 
: 입력을 충실히 반영하되, 해당 과제를 수행할 때 보편적으로 성립하는 정보만 추론하며, 사용자나 환경 에 따라 달라질 수 있는 정보는 추론하거나 추가하지 않는다.

Decomposition
: 과제를 사용자가 부담 없이 즉시 시작할 수 있는 최소 현실 행동까지 분해하며, 기본적으로 약 10초 내외 (일반적으로 30초 이하)에 완료 가능한 크기로 구성 한다.

Scale
: 전체 Step은 과제의 복잡도에 맞게 균형 있게 구성 하며, 일반적으로 10~25개를 목표로 하고, 필요한 경우에만 이 범위를 벗어난다.
